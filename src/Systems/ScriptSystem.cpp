...
ScriptSystem::ScriptSystem() { RequireComponent<ScriptComponent>(); }

void ScriptSystem::CreateLuaBindings(std::unique_ptr<Registry> &registry,
...
void ScriptSystem::Update(double deltaTime, int ellapsedTime) {
